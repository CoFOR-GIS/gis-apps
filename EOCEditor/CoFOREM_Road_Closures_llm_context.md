# Layer Schema: CoFOREM_Road_Closures
...
| Property | Value |
| --- | --- |
| URL | `https://services6.arcgis.com/Cnwpb7mZuifVHE6A/arcgis/rest/services/CoFOREM_Emergency_Operations/FeatureServer/1` |
| Geometry | Polyline |
...
| Name | Fields | Unique |
| --- | --- | --- |
| PK__COFOREM___F4B70D8527583579 | `OBJECTID` | Yes |
| user_47476.COFOREM_EMERGENCY_OPERATIONS_COFOREM_ROAD_CLOSURES_Shape_sidx | `Shape` | No |
| Shape__Length_Index | `Shape__Length` | No |
...
### CoFOREM_Road_Closures

All defaults null.

## Field Schema (21 fields)
...
| 14 | `ClosureType` | Closure Type | String | 10 | Yes | Yes |  | CoFOREM_ClosureType: FULL=Full Closure, LANE=Lane Closure, ALT=One-Lane Alternating, LOWWATER=Low Water Crossing - Impassable |
| 15 | `DetourDesc` | Detour Description | String | 500 | Yes | Yes |  | — |
| 16 | `RoadName` | Road Name | String | 100 | Yes | Yes |  | — |
| 17 | `CreatedBy` | CreatedBy | String | 255 | Yes | No |  | — |
| 18 | `CreatedDate` | CreatedDate | Date | 8 | Yes | No |  | — |
| 19 | `UpdatedBy` | UpdatedBy | String | 255 | Yes | No |  | — |
| 20 | `UpdatedDate` | UpdatedDate | Date | 8 | Yes | No |  | — |
| 21 | `Shape__Length` | Shape__Length | Double | — | Yes | No |  | — |
