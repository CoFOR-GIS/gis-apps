# Layer Schema: CoFOREM_Emergency_Areas
...
| Property | Value |
| --- | --- |
| URL | `https://services6.arcgis.com/Cnwpb7mZuifVHE6A/arcgis/rest/services/CoFOREM_Emergency_Operations/FeatureServer/2` |
| Geometry | Polygon |
...
| Name | Fields | Unique |
| --- | --- | --- |
| PK__COFOREM___F4B70D85F07A0B90 | `OBJECTID` | Yes |
| user_47476.COFOREM_EMERGENCY_OPERATIONS_COFOREM_EMERGENCY_AREAS_Shape_sidx | `Shape` | No |
| Shape__Area_Index | `Shape__Area` | No |
...
### CoFOREM_Emergency_Areas

All defaults null.

## Field Schema (19 fields)
...
| 18 | `Shape__Area` | Shape__Area | Double | — | Yes | No |  | — |
| 19 | `Shape__Length` | Shape__Length | Double | — | Yes | No |  | — |
